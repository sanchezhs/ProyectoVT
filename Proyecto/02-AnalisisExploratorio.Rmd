...
kable(virusTotal, booktabs = TRUE) %>%
...
virusTotal1 <- virusTotal %>%
  arrange(desc(size)) %>%
  slice(1:10)
kable(virusTotal1, booktabs = TRUE) %>%
  kable_styling(font_size = 10)
```
...
virusTotal2 <- virusTotal %>%
  arrange(file_type)
kable(virusTotal2, booktabs = TRUE) %>%
  kable_styling(font_size = 10)
```
...
virusTotal3 <- virusTotal %>%
  ...
  arrange(size)
kable(virusTotal3, booktabs = TRUE) %>%
  kable_styling(font_size = 10)
```
...
virusTotal4 <- virusTotal %>%
  ...
  slice(1)
kable(virusTotal4, booktabs = TRUE) %>%
  kable_styling(font_size = 10)
```
...
kable(virusTotal5, booktabs = TRUE) %>%
  kable_styling(font_size = 10)
```
